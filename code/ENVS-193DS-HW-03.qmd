...
One critique of this table is that the most critical part for understanding the statistical tests is very small at the bottom. However, it is in italics to draw the eye, and if it were larger, it would probably look very overwhelming. Overall, it's lack of visual clutter is nice, but the legend at the bottom may be more easily readable if it were bold. 