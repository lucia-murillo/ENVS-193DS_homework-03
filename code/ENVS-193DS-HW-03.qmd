...
## (e) 
I found that kelp elongation rates tend to decrease as temperatures increase. There is a moderate negative relationship between these two variables (Pearson's r = -0.69, p = 1.366e-05, \u03B1 = 0.05). 
**FINISH LATER** **ASK ABT DOING A LM** 
...
cor.test(~ temp_c + kelp_elong,
         ...
         method = "spearman")
```
**make sure results are displayed** 
...
**Figure 2: The relationship between studuing start time and productivity.** Each point represents a single study session. 
**MAKE THAT ONE A LM??** 
