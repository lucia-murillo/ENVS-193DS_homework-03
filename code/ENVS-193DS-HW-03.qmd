...
## (d) 
To evaluate the strength of the relationship between ocean water temperature and kelp elongation, I used a Pearson's correlation test because the data is linear. I found a strong negative (Pearson's r = -0.69) relationship between ocean temperature and kelp elongation (p = 1.366e-05, \u03B1 = 0.05)

## (e) 
I found that kelp elongation rates tend to decrease as temperatures increase. There is a strong negative relationship between these two variables (Pearson's r = -0.69, p = 1.366e-05, \u03B1 = 0.05). 
